class DeveloperContent {
    ...
    renderCombinedNavigation() {
        ...
        networkContainer.innerHTML = `
            <div class="developer-card bg-transparent p-6 mb-6">
        ...
        switch (tabName) {
                ...
                content = `
                    <div class="developer-card bg-transparent p-6 mb-6">
                        ...
                        <div>
                            ...
                            <h4 class="text-sm font-semibold text-white mb-3 mt-6">For developers:</h4>
                            <div class="space-y-2 text-sm">
                                <div class="break-words">
                            ...
                            <h4 class="text-sm font-semibold text-white mb-3 mt-6">Build & Learn:</h4>
                            <div class="space-y-2 text-sm">
                                <div class="break-words">
                        ...
                        <div>
                            <h4 class="text-sm font-semibold text-white mb-3">Community:</h4>
                            <div class="space-y-2 text-sm">
                                <div class="break-words">
                            ...
                            <h4 class="text-sm font-semibold text-white mb-3 mt-6">Official Platform:</h4>
                            <div class="space-y-2 text-sm">
                                <div class="break-words">
                                ...
                                <div class="break-words">
                                    ...
                                    <a href="https://testnet.staking.story.foundation" class="text-blue-400 hover:text-blue-300 transition-colors ml-1 break-words">https://testnet.staking.story.foundation</a>
                                </div>
                            </div>

                            <h4 class="text-sm font-semibold text-white mb-3 mt-6">Other:</h4>
                            <div class="space-y-2 text-sm">
                                <div class="break-words">
            ...
            case 'endpoints':
                content = `
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <h4 class="text-sm font-semibold text-white mb-3">Network Info:</h4>
                            <div class="space-y-2 text-sm">
                                <div class="break-words">
                            ...
                            <h4 class="text-sm font-semibold text-white mb-3 mt-6">RPC Endpoints:</h4>
                            <div class="space-y-2 text-sm">
                                <div class="break-words">
                            ...
                            <h4 class="text-sm font-semibold text-white mb-3 mt-6">API Endpoints:</h4>
                            <div class="space-y-2 text-sm">
                                <div class="break-words">
                                    <span class="text-white">Docs:</span>
                        ...
                        <div>
                            <h4 class="text-sm font-semibold text-white mb-3">Other:</h4>
                            <div class="space-y-2 text-sm">
                                <div class="break-words">
                            ...
                            <h4 class="text-sm font-semibold text-white mb-3 mt-6">Node Software:</h4>
                            <div class="space-y-2 text-sm">
                                <div class="break-words">
                ...
                content = `
                    <div class="developer-card bg-transparent p-6 mb-6">
                        ...
                        <div>
                            ...
                            <h4 class="text-sm font-semibold text-white mb-3 mt-6">Smart Contracts:</h4>
                            <div class="space-y-2 text-sm">
                                <div class="break-words">
                        ...
                        <div>
                            <h4 class="text-sm font-semibold text-white mb-3">Templates:</h4>
                            <div class="space-y-2 text-sm">
                                <div class="break-words">
                            ...
                            <h4 class="text-sm font-semibold text-white mb-3 mt-6">Explorers:</h4>
                            <div class="space-y-2 text-sm">
                                <div class="break-words">
            ...
            case 'explorers':
                content = `
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <h4 class="text-sm font-semibold text-white mb-3">Explorers (Official):</h4>
                            <div class="space-y-2 text-sm">
                                <div class="break-words">
                            ...
                            <h4 class="text-sm font-semibold text-white mb-3 mt-6">Explorers (Community):</h4>
                            <div class="space-y-2 text-sm">
                                <div class="break-words">
                                    <span class="text-white">• Stakscan:</span>
                        ...
                        <div>
                            <h4 class="text-sm font-semibold text-white mb-3">Dashboards (Official):</h4>
                            <div class="space-y-2 text-sm">
                                <div class="break-words">
                                    <span class="text-white">• Story:</span>
                                    <a href="https://staking.story.foundation" class="text-blue-400 hover:text-blue-300 transition-colors ml-1 break-words">https://staking.story.foundation</a>
                            ...
                            <h4 class="text-sm font-semibold text-white mb-3 mt-6">Dashboards (Community):</h4>
                            <div class="space-y-2 text-sm">
                                <div class="break-words">
                                    <span class="text-white">• Krew:</span>
                                    <a href="https://story-dashboard.krew.xyz/story" class="text-blue-400 hover:text-blue-300 transition-colors ml-1 break-words">https://story-dashboard.krew.xyz/story</a>
                                </div>
                                <div class="break-words">
                                    <span class="text-white">• OriginStake:</span>
                                    <a href="https://iport4.io/" class="text-blue-400 hover:text-blue-300 transition-colors ml-1 break-words">https://iport4.io/</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <div class="space-y-2 text-sm">
                                    <div class="break-words">
                                        <span class="text-white">• Krew:</span>
                                        <a href="https://story-dashboard.krew.xyz/story-aeneid/" class="text-blue-400 hover:text-blue-300 transition-colors ml-1 break-words">https://story-dashboard.krew.xyz/story-aeneid/</a>
                                    </div>
                                    <div class="break-words">
                                        <span class="text-white">• OriginStake:</span>
                                        <a href="https://iport4.io/" class="text-blue-400 hover:text-blue-300 transition-colors ml-1 break-words">https://iport4.io/</a>
            ...
            case 'faucet':
                content = `
                    ...
                    <div>
                        <h4 class="text-sm font-semibold text-white mb-3">Faucet List:</h4>
                        <div class="space-y-2 text-sm">
                            <div>
